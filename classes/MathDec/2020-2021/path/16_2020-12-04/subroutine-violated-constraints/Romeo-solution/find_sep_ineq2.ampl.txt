...
subject to H1ok: 
        sum{i in EDGES} H1[i] * c[i] >= b+sep;
subject to H2ok: 
        sum{i in EDGES} H2[i] * c[i] >= b+sep;
subject to H3ok: 
        sum{i in EDGES} H3[i] * c[i] >= b+sep;
...
# Stampa della soluzione che massimizza sep:
printf "*************************************\n\nHo computato una soluzione che massimizzi sep.\nEccone una descrizione:\n";
